...
When computing the pEW, the flux is interpolated with a step similar to the spectrum’s resolution, aligning the spectrum pixels with bandpass edges, and the continuum level is approximated as a user-defined percentile of the flux around the spectral line.
